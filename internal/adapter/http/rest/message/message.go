...
func (m messageHandler) SendSMS(c *gin.Context) {
...
func (m messageHandler) SendBatchSMS(c *gin.Context) {
...
func (m messageHandler) ReceiveSMS(c *gin.Context) {
	message := &dto.Message{}
	err := c.ShouldBind(message)
	if err != nil {
		_ = c.Error(errorx.IllegalArgument.New(error_types.ErrorInvalidRequestBody))
...
func (m messageHandler) GetAllClientMessages(c *gin.Context) {
